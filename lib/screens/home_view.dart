    ...
    return InkWell(
      onTap: () {
        Voteringar selectedVote =
            context.read<ProviderVoteringsVy>().voteringar[index];
...
class VoteringsVy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var voteringsDisplay =
        context.watch<ProviderVoteringsVy>().voteringsDisplay;
    var selectedVotering =
        context.watch<ProviderVoteringsVy>().selectedVotering;
        ...
        child: Column(children: [
          ...
          Padding(
              ...
              child: ToggleButtons(
                ...
                onPressed: (int index) {
                  context
                      .read<ProviderVoteringsVy>()
                      .getSelectedVotering(index);
                },
